function [flickerTexture]=flickerTexture_all_class_fixed(winWidth,winHeight,targetWidth,targetHeight,class_x,class_y, margin_x, margin_y,unique_arrays)
...
for i = 1 : size(targetMatrix,2)
    screenMatrix{size(unique_arrays,1)+1} = screenMatrix{size(unique_arrays,1)+1} + targetMatrix{i};
end
